      ...
      >
        <View style={styles.hero}>
          ...
          <Text style={styles.heroDescripcion}>
            Consulta tus datos personales y administra la información de tu cuenta.
          </Text>
        </View>
        ...
        <MensajeEstado variante="info" titulo="Próximamente editable">
          En los siguientes commits habilitaremos editar datos, cambiar foto de perfil y actualizar contraseña.
        </MensajeEstado>
        ...
        <View style={styles.seccion}>
          <View style={styles.seccionEncabezado}>
            ...
            <Text style={styles.seccionDescripcion}>
              Estas opciones quedarán activas en los próximos commits.
            </Text>
          </View>
