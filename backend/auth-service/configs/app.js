...
import '../../report-service/src/reports/report.model.js';
import '../../report-service/src/reports/report-image.model.js';
import '../../report-service/src/reports/report-status-history.model.js';

// Comentarios, seguimiento y notificaciones
import '../../report-service/src/reports/report-comment.model.js';
import '../../report-service/src/reports/report-follower.model.js';
import '../../report-service/src/reports/report-notification.model.js';

// ─── Middlewares globales
import { requestLimit }           from '../../report-service/middlewares/request-limit.js';
...
import reportRoutes       from '../../report-service/src/reports/report.routes.js';

// Análisis IA — analizar imagen, crear reporte asistido por IA
import aiRoutes           from '../../report-service/src/reports/ai.routes.js';

// Detección de duplicados — similar y check-duplicates
import duplicateRoutes    from '../../report-service/src/reports/duplicate.routes.js';

// Comentarios de reportes
import commentRoutes      from '../../report-service/src/reports/comment.routes.js';

// Notificaciones in-app del usuario autenticado
import notificationRoutes from '../../report-service/src/reports/notification.routes.js';

// Estadísticas y analíticas (dashboard, trends, zones, export, heatmap-grid, transitions)
import statsRoutes        from '../../report-service/src/reports/stats.routes.js';
...
export const initServer = async () => {
  ...
  try {
    ...
    const { seedRoles } = await import('../../report-service/helpers/role-seed.js');
    await seedRoles();

    const { seedAdmin } = await import('../../report-service/helpers/admin-seed.js');
    await seedAdmin();
    ...
    const { createSpatialIndex, createCompositeIndexes } =
      await import('../../report-service/src/reports/report.model.js');
